...
| :white_check_mark: | 17 | OOP (1) | Create a `Car` Class with:<br>- attributes: Brand, Model, Age<br>- Methods: start(), stop() |
| :new: | 18 | OOP (2) | Create `Animal` Class and child Class `Cat` and `Dog`, each having different implementation of `make_sound()` |